...
function LeaderboardRequest() {
    ...
    this.getPlayerScore = function(leaderboard, timespan, ranktype, callbackfnc) {
        ...
        if(!ANDROID) {
            ...
            Android.GPGLeaderboard_getPlayerScore(leaderboard, timespan, ranktype, callbackfnc.toString());   
        }
    };
    this.listLeaderboardScore = function(leaderboard, timespan, ranktype, callbackfnc) {
        ...
        if(!ANDROID) { 
            ...
            Android.GPGLeaderboard_listLeaderboardScore(leaderboard, timespan, ranktype, callbackfnc.toString());
        }
    };
    this.update = function(leaderboard, score, callbackfnc) {
        if(!ANDROID) {
            ...
            Android.GPGLeaderboard_update(leaderboard, score, callbackfnc.toString());
        }
    };
...
function AchievementRequest() {
    ...
    this.increment = function(achievement, steps, callbackfnc /* with params currSteps & newly unlocked */) {
        if(!ANDROID) {
            ...
            Android.GPGAchievement_increment(achievement, steps, callbackfnc.toString());
        }
    };
    ...
    this.reveal = function(achievement, callbackfnc /* with param of currentstate */) {
        ...
        if(!ANDROID) {
            ...
            Android.GPGAchievement_reveal(achievement, callbackfnc.toString());
        }
    };
    ...
    this.setSteps = function(achievement, minSteps, callbackfnc /* currentSteps, newlyUnlocked */) {
        if(!ANDROID) {
            ...
            Android.GPGAchievement_setSteps(achievement, minSteps, callbackfnc.toString());
        }
    }
    ...
    this.unlock = function(achievement, callbackfnc /* newlyUnlocked */) {
        if(!ANDROID) {
            ...
            Android.GPGAchievement_unlock(achievement, callbackfnc.toString());
        }
    }
